/**
 * @ask-jenny/spec-parser
 *
 * XML spec parser for Ask Jenny - parses and generates app_spec.txt XML.
...
// Re-export types from @ask-jenny/types for convenience
export type { SpecOutput } from '@ask-jenny/types';
